...
/***/ (function(module, exports, __webpack_require__) {
	...
	var currentMove = 0;
	var currentMoveArray = [];
	var statisticsArray = [];
	var idClicked = '';

	var winner = function winner(game) {
	  if (game.cells[0] === game.cells[1] && game.cells[1] === game.cells[2]) {
	    return game.cells[0];
	  } else if (game.cells[3] === game.cells[4] && game.cells[4] === game.cells[5]) {
	    return game.cells[3];
	  } else if (game.cells[6] === game.cells[7] && game.cells[7] === game.cells[8]) {
	    return game.cells[6];
	  } else if (game.cells[0] === game.cells[3] && game.cells[3] === game.cells[6]) {
	    return game.cells[0];
	  } else if (game.cells[1] === game.cells[4] && game.cells[4] === game.cells[7]) {
	    return game.cells[1];
	  } else if (game.cells[2] === game.cells[5] && game.cells[5] === game.cells[8]) {
	    return game.cells[2];
	  } else if (game.cells[0] === game.cells[4] && game.cells[4] === game.cells[8]) {
	    return game.cells[0];
	  } else if (game.cells[2] === game.cells[4] && game.cells[4] === game.cells[6]) {
	    return game.cells[2];
	  }
	  return '';
	};

	var _isOver = function isOver(game, cell, move) {
	  game.cells[cell.index] = cell.value;
	  _isOver = winner(game) !== '' || move + 1 > 9;
	...
	var showStatistics = function showStatistics(games) {
	...
	module.exports = {
	  ...
	  currentMoveArray: currentMoveArray,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetGame = function onGetGame(event) {
	  ...
	  api.show(data).then(ui.onGetGameSuccess).catch(ui.onGetGameFailure);
	};

	var onUpdateGame = function onUpdateGame(event) {
	  event.preventDefault();
	  var currentForm = event.currentTarget;
	  var data = getFormFields(currentForm);
	...
	var onCreateGame = function onCreateGame(event) {
	  ...
	  // console.log(data)
	  api.create().then(addGameboardClickHandlers).then(ui.onCreateGameSuccess).catch(ui.onCreateGameFailure);
	};
	...
	var addGameboardClickHandlers = function addGameboardClickHandlers() {
	...
	module.exports = {
	  ...
	  onGetGame: onGetGame,
	  addGameboardClickHandlers: addGameboardClickHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var gameEngine = __webpack_require__(10);
	...
	var onUpdateGameSuccess = function onUpdateGameSuccess(response) {
	  var winner = gameEngine.winner(gameEngine.currentGame);
